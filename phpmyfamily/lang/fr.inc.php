...
//=====================================================================================================================
	...
	$strIndex			= "Tous les détails pour les individus nées après $dispdate sont privées afin de protéger les identités.  Si vous êtes enregistré(e) vous pourrez voir et modifier les enregistrements.  Si vous croyez que votre arbre généalogique correspond à celui-ci, <a href=\"$1\">laissez-moi savoir</a>.";
	$strNote			= "Note";
