...
//=====================================================================================================================
	...
	$strUnknown			= "inconnu";
	$strLoggedIn		= "Vous êtes authentifé sous ";
	$strAdmin			= "admin";
	...
	$strBack			= "Retour";
	$strToHome			= "au départ.";
	$strNewMsg			= "Assurez-vous que la personne n'existe pas déjà dans la base de données!";
	$strIndex			= "Tous les détails pour les personnes nées après $dispdate sont privées afin de protéger les identités.  Si vous êtes enregistré(e) vous pourrez voir et modifier les enregistrements.  Si vous croyez que votre arbre généalogique correspond à celui-ci, <a href=\"$1\">laissez-moi savoir</a>.";
	$strNote			= "Note";
    ...
    $strCeaseRequest	= "Votre reqête de cessation de suivi cet individu est en traitement.<br />Un courriel a été envoyé à votre adresse et vous devrez suivre les instructions qui y sont inscrites.<br />";
