...
//=====================================================================================================================
	...
	$strIndex			= "Alle details over mensen die na de $dispdate geboren zijn, zijn in toegang beperkt om hun identiteit te beschermen. Als geregistreerd gebruiker bent u gerechtigd die details in te zien en te veranderen.  Het is iedereen toegestaan de onbeschermde gegevens in te zien. Als u denkt dat iemand, die hier is opgenomen, in uw familiestamboom past, of als u een account wilt, <a href=\"$1\">laat het mij dan weten.</a>";
	$strNote			= "Let op:";
