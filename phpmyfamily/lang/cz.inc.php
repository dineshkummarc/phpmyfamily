...
//=====================================================================================================================
	...
	$strIndex			= "Pøístup k údajùm o osobách narozených pøed datem $dispdate je z dùvodu ochrany osobních dat omezen.  Prohlížení ostatních záznamù není uživatelùm omezeno.  Pokud se domníváte, že nìkdo ze zde uloženého seznamu osob patøí i Vašeho rodinného stromu, <a href=\"$1\">napište mi</a>.";
	$strNote			= "Poznámka";
