...
//=====================================================================================================================
	...
	$strIndex			= "Tutti i dettagli per le persone nate dopo $currentRequest->dispdate sono limitate a proteggere le loro identità.  Se sei un utente registrato puoi vedere i loro dettagli ed editarli.  Chiunque è libero di consultare i risultati non confidenziali. Se credi che qualcuno di questi appartenga al tuo albero genealogico, dei pregato <a href=\"$1\">d'informarmi</a>";
	$strNote			= "Note";
