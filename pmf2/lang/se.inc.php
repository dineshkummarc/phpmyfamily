...
//=====================================================================================================================
	...
	$strdatumDescr[0]    = "";    // Default for old entries without details
	$strdatumDescr[1]    = "omkring"; // dev < 1 year
	$strdatumDescr[2]    = "cirka"; // dev <5 år
	$strdatumDescr[3]    = "skattad"; // dev. < 15 år
	$strdatumDescr[4]    = "grovt"; // dev > 15 år
	$strdatumDescr[5]    = "beräknad"; // Gedcom compatible
	$strdatumDescr[6]    = "innan"; // Gedcom compatible
	$strdatumDescr[7]    = "efter"; // Gedcom compatible
	$strdatumDescr[8]    = "den"; // exact datum
	$strdatumDescr[9]    = "vid"; // day not known
	$strdatumDescr[10]   = "trolig"; // source inconclusive
	
	$strdatumExplain[0]    = "Förvalt värde";
	$strdatumExplain[1]    = "inom 1 år";
	$strdatumExplain[2]    = "om 5 år";
	$strdatumExplain[3]    = "om 15 år";
	$strdatumExplain[4]    = "mer än 15 år";
	$strdatumExplain[5]    = "beräknad"; // Gedcom compatible
	$strdatumExplain[6]    = "innan"; // Gedcom compatible
	$strdatumExplain[7]    = "efter"; // Gedcom compatible
	$strdatumExplain[8]    = "exakt datum";
	$strdatumExplain[9]    = "dag okänd";
	$strdatumExplain[10]   = "säker källa";
